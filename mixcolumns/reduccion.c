...
int main (){
 ...
 char x4 = mensaje[4] ^ mensaje[12]^ mensaje[11]^ mensaje[9]^ mensaje[8]^ mensaje[15]^ mensaje[14]^ mensaje[13]^ mensaje[15]^ mensaje[13];
 char x5 = mensaje[5]^ mensaje[13]^ mensaje[12]^ mensaje[10]^ mensaje[9]^ mensaje[15]^ mensaje[14]^ mensaje[14];
...
printf("Reduccion: %d %d %d %d %d %d %d %d \n", reduc[0], reduc[1], reduc[2], reduc[3], reduc[4], reduc[5], reduc[6], reduc[7]);
  return 0;
 }
